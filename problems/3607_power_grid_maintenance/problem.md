...
- Hint 3: For query [2, x], remove x from the set of its component
- Hint 4: For query [1, x], if x is in its component’s set return x; otherwise if the set is non-empty return its smallest element; else return -1
