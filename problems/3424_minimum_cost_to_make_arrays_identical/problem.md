...
- Hint 2: Calculate sum(abs(arr[i] - brr[i])) if you do not use Operation 1.
- Hint 3: Calculate sum(abs(arr[i] - brr[i])) after sorting both arrays if you use Operation 1.
