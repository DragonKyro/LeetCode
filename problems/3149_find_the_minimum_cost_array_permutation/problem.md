...
- Hint 1: The score function is cyclic, so we can always set perm[0] = 0 for the smallest lexical order.
- Hint 2: It’s similar to the Traveling Salesman Problem. Use Dynamic Programming.
- Hint 3: Use a bitmask to track which elements have been assigned to perm.
