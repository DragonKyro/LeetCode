...
- Hint 2: Begin by constructing the answer starting with the first number in groups.
- Hint 3: For each index i in the range [1, n - 1], add i to the answer if groups[i] != groups[i - 1].
