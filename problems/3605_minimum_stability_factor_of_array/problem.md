...
- Hint 1: Binary‐search the target length k
- Hint 2: For each k, use fast range‐GCD queries
- Hint 3: Greedily "hit" every window of size k+1 with an edit if its GCD > 1
