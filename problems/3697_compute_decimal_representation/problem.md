...
- Hint 1: Break the number down digit by digit starting from the ones place.
- Hint 2: Each nonzero digit contributes a base-10 component.
- Hint 3: Collect all components and return them in descending order.
