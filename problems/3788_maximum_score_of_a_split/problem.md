...
- Hint 2: Precompute the prefix sums of nums and the suffix minimums for all valid split positions.
- Hint 3: For each split index i, compute score(i) = prefixSum(i) - suffixMin(i) and keep track of the maximum value.
