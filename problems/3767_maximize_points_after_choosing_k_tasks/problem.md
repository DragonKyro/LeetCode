...
- Hint 1: Initially complete all tasks using way 1; let the initial total be sum(reward1).
- Hint 2: The delta when switching task i from way 1 to way 2 is reward2[i] - reward1[i].
- Hint 3: Sort deltas descending and apply the largest n - k; after each switch update the maximum.
