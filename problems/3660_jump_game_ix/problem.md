...
- Hint 2: From index i, forward jumps go only to smaller values; backward jumps go only to larger values.
- Hint 3: The maximum reachable value from i is the maximum value in the connected component reachable under these jump rules.
