...
- Hint 2: Let the count of a's be count_a and the count of b's be count_b. Can we derive the final length from these?
- Hint 3: The answer is abs(count_a - count_b)
