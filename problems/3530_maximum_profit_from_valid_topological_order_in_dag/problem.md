...
- Hint 2: States are mask = (bits such that if a bit is set, it means the corresponding node is removed).
- Hint 3: Try maintaining the degrees across function calls.
