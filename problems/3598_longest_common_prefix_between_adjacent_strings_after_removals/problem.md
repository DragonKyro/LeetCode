...
- Hint 2: After deleting words[i], compute the longest common prefix for words[i - 1] and words[i + 1] (if they exist).
- Hint 3: Use the result of the prefix computation up to i - 1 and the suffix computation from i + 1 onwards.
