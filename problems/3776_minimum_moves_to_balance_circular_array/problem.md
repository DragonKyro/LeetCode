...
- Hint 2: Sort the positive values in nums by their distance from the index with the negative value.
- Hint 3: Greedily use as many values as needed from the sorted nums to offset the current negative value.
