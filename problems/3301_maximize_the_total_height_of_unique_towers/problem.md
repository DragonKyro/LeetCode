...
- Hint 1: Sort the array maximumHeight in descending order.
- Hint 2: After sorting, it can be seen that the maximum height that we can assign to the i^th element is min(maximumHeight[i], maximumHeight[i - 1] - 1).
