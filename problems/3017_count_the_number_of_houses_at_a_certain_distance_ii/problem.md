...
- Hint 1: If there were no additional street connecting house x to house y, there would be 2 * (n - i) pairs of houses at distance i.
- Hint 2: The shortest distance between house i and house j (j  j
- - i -> y---x -> j
- Hint 3: Try to change the distances calculated by path i ->j to the other path.
