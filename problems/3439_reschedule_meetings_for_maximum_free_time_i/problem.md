...
- Hint 1: In a sequence of K meetings and K + 1 gaps, you could move all meetings to the start of the sequence to get the max free time.
- Hint 2: Use a sliding window of K + 1 size to store sum of gaps and take the maximum.
