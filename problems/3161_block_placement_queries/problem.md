...
- Hint 1: Let d[x] be the distance of the next obstacle after x.
- Hint 2: For each query of type 2, we just need to check if max(d[0], d[1], d[2], …d[x - sz]) > sz.
- Hint 3: Use segment tree to maintain d[x].
