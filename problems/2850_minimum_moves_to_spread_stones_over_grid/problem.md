...
- Hint 1: There are at most 4 cells with more than one stone.
- Hint 2: Let a be the number of cells containing more than one stone, and b be the number of cells containing no stones. . b^a ≤ 6561. Use this fact to come up with a bruteforce.
