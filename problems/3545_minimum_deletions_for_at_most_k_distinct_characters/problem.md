...
- Hint 1: Compute the frequency of each character in s and collect these into a list counts.
- Hint 2: Sort counts in ascending order.
- Hint 3: Let d = (number of distinct characters) – k. If d <= 0, return 0.
- Hint 4: Otherwise, the minimum deletions is the sum of the first d entries in counts (removing the d least-frequent characters).
