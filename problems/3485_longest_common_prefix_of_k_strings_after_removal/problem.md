...
- Hint 3: For each arr[i], remove it from the trie and update the counts.
- Hint 4: During evaluation, find the innermost node with at least k paths ending there.
