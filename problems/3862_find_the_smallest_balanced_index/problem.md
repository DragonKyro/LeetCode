...
- Hint 1: Compute prefix sums for elements to the left of each index.
- Hint 2: Compute suffix products for elements to the right with overflow checks.
- Hint 3: Check each index i where left sum == right product.
- Hint 4: Return the smallest such index, or -1 if none exists.
