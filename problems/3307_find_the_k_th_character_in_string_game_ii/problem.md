...
- Hint 1: Try to replay the operations k^th character was part of.
- Hint 2: The k^th character is only affected if it is present in the first half of the string.
