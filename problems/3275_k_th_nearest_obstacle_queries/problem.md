...
- Hint 1: Consider if there are more than k obstacles. Can the k + 1^th obstacle ever be the answer to any query?
- Hint 2: Maintain a max heap of size k, thus heap will contain minimum element at the top in that queue.
