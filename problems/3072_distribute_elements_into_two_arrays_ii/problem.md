...
- Hint 1: We need a data structure that counts the number of integers greater than a given value x and supports insertion.
- Hint 2: Use Segment Tree or Binary Indexed Tree by compressing the numbers to the range [1,n].
