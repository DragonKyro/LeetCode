...
- Hint 2: Let the prefix sum array be p; notice that for a stable range [l, r], the condition becomes p[r - 1] - p[l] == a[r] and a[l] == a[r]
- Hint 3: For each index r, you want to count the number of previous indices l such that p[l] == p[r - 1] - a[r] and a[l] == a[r]
- Hint 4: You can do this efficiently by maintaining a map from (a[i], p[i]) to a frequency count as you iterate
