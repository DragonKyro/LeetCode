...
- Hint 1: Filter out words with length < k; they can never participate in any valid group.
- Hint 2: Two words are connected exactly when their first k characters are identical; this reduces the problem to grouping by prefix.
