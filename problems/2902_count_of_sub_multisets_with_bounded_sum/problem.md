...
- Hint 1: Since the sum of numsis at most 20000, the number of distinct elements of nums is 200.
- Hint 2: Let dp[x] be the number of submultisets of nums with sum x.
- Hint 3: The answer to the problem is dp[l] + dp[l+1] + … + dp[r].
