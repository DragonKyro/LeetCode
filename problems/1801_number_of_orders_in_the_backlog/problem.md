...
You are given a 2D integer array orders, where each orders[i] = [price_i, amount_i, orderType_i] denotes that amount_i_ orders have been placed of type orderType_i at the price price_i. The orderType_i is:
