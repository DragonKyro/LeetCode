...
- Hint 2: If cost2 > cost1 * 2, we should just use cost1 to change all the values to the maximum one.
- Hint 3: Otherwise, it's optimal to choose the smallest two values and use cost2 to increase both of them.
