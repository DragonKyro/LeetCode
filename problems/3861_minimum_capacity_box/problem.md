...
- Hint 1: Iterate to find the minimum capacity >= itemSize, updating index only on strictly smaller finds.
- Hint 2: Handle ties by keeping the earliest index.
- Hint 3: Return -1 if no valid box exists.
