...
- Hint 1: Create a graph with n + 4 vertices.
- Hint 2: Vertices 0 to n - 1 represent the circles, vertex n represents upper edge, vertex n + 1 represents right edge, vertex n + 2 represents lower edge, and vertex n + 3 represents left edge.
- Hint 3: Add an edge between these vertices if they intersect or touch.
- Hint 4: Answer will be false when any of two sides left-right, left-bottom, right-top or top-bottom are reachable using the edges.
