...
- Hint 1: area * 2 = base * height
- Hint 2: Let the base be parallel to the x‑axis or y‑axis
- Hint 3: Sort to find the maximum base for each fixed x (or y), then the maximum height comes from the extreme values of the other coordinate.
