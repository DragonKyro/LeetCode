...
- Hint 1: Generate all primes up to nums.length (e.g., with the Sieve of Eratosthenes).
- Hint 2: Iterate through nums, adding nums[i] to sumA if i is prime, otherwise to sumB, then return |sumA - sumB|.
