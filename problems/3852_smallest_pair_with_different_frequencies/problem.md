...
- Hint 1: Calculate the frequency of each element in the array using a hash map or frequency array.
- Hint 2: Find the smallest element that has a different frequency from the smallest element.
