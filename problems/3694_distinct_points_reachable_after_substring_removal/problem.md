...
- Hint 1: Use prefix sums for the x-coordinate and y-coordinate.
- Hint 2: Using the prefix sum arrays, compute the x-coordinate and y-coordinate after removing a subarray of size k.
